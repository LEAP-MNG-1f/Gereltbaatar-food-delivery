...
export const Footer = () => {
  return (
    <footer>
      <div className="">
        <div className="bg-BrandGreen flex items-center justify-center relative overflow-hidden">
          <div
            className="h-full w-full pt-[114px] pb-[109px]"
            style={{
              background: "url('./HeroTraced.png'), #18BA51",
            }}
          >
